...
public class DataGenerator {
    ...
    public static void main(String[] args) {
        ...
        createEventSubscriptionData(processEngineConfiguration);
    ...
    private static void createEventSubscriptionData(ProcessEngineConfigurationImpl processEngineConfiguration) {
